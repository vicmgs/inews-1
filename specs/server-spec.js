...
describe('server-side getNews GET request spec', function () {
  ...
  it('should pass this canary test', function() {
    expect(true).to.be.true;
      ...
      xit('GET request should respond 200 for /getNews', function (done) {
        request(server)
        .get('/api/getnews')
        .expect(200, done)
      });

      xit('GET request should respond 200 for /getUserPrefs', function (done) {
        request(server)
      ...
      xit('GET request should respond with a res.body that is an object', function(done){
      ...
      xit('GET request should respond with a res.body that is a collection of stories properties: name, image, url ', function(done){
