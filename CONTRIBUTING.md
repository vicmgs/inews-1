...
4. When you've finished with your fix or feature, Rebase upstream 
  (git pull --rebase upstream master) changes into your branch. submit a [pull request][] directly to master. Include a description of your changes.
...
```
git remote add upstream https://github.com/<YOUR_ORG>/<NAME_OF_REPO>.git
```
